UPDATE_POST = """UPDATE posts 
            SET uniqueId = %s, postUrl= %s, 
            postKarma = %s, commentKarma= %s,
            postDate= %s, numberOfComments =%s,
...
INSERT_POST = """INSERT INTO posts (uniqueId,postUrl,postKarma,commentKarma,postDate,numberOfComments,numberOfvotes,
              postCategory,userId,postAddedDate) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) ;"""
INSERT_USER = 'INSERT INTO users (username,userKarma,userCakeDay) VALUES (%s,%s,%s) ;'
